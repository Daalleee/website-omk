...
<section class="section" style="background:var(--white);" id="pengurus">
    <div class="container">
        ...
        @php
            $homeGroups = ['inti' => 'Inti', 'pendamping' => 'Pendamping', 'kerohanian' => 'Bidang Kerohanian', 'sosial' => 'Bidang Sosial', 'seni_budaya' => 'Bidang Seni & Budaya', 'olahraga' => 'Bidang Olahraga', 'usaha' => 'Koordinator Usaha', 'liturgi' => 'Koordinator Liturgi', 'perlengkapan' => 'Koordinator Perlengkapan'];
            ...
            @foreach($homeGroups as $key => $label)
                ...
                <div class="fade-in">
                    ...
                    <div style="display:flex;justify-content:center;flex-wrap:wrap;gap:1.5rem;">
                        ...
                        <div style="text-align:center;width:100%;max-width:{{ $key === 'inti' ? '260px' : '220px' }};">
